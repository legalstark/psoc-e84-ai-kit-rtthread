...
/*
 * RT-Thread application pipe reservation.
 *
 * IPC1 channels 17-20 and interrupts 9-12 are intentionally left available
 * to MTB-IPC/MTB-SRF. The application owns one bidirectional pipe using the
 * following remaining user resources.
 */
#define AI_KIT_RTTHREAD_IPC_CM33_CHANNEL            (21UL)
#define AI_KIT_RTTHREAD_IPC_CM55_CHANNEL            (22UL)
#define AI_KIT_RTTHREAD_IPC_CM33_INTERRUPT          (13UL)
#define AI_KIT_RTTHREAD_IPC_CM55_INTERRUPT          (14UL)
