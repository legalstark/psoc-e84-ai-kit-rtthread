...
int main(void)
{
    ...
    */
    ...
    SECURE_PRINTF("PSRAM Cache is Enabled\r\n");
#else
    SECURE_PRINTF("PSRAM Cache is Disabled\r\n");
#endif
    ...
    SECURE_PRINTF("PSRAM init successful \r\n");
