...
#ifdef BSP_USING_SPI_RADAR
static cy_stc_scb_spi_context_t scb_3_spi_context;
...
#define RADAR_SPI_CS_PIN GET_PIN(CYBSP_RSPI_CS_PORT_NUM, CYBSP_RSPI_CS_PIN)
#endif
...
static struct ifx_spi ifx_spi_obj[] = {
#ifdef BSP_USING_SPI_RADAR
    {
        ...
        .default_cfg = &CYBSP_SPI_CONTROLLER_config,
        .hal_cfg = &CYBSP_SPI_CONTROLLER_hal_config,
        .context = &scb_3_spi_context,
        .cs_pin = RADAR_SPI_CS_PIN,
        .intr_cfg = { .intrSrc = CYBSP_SPI_CONTROLLER_IRQ, .intrPriority = INT_PRIORITY },
    },
#endif
};
