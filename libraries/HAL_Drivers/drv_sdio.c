...
/* Device Configurator uses board-specific aliases for the same SDHC0 block. */
#if defined(TARGET_APP_KIT_PSE84_AI)
#define CY_PSE_SDIO0_HW              CYBSP_WIFI_SDIO_HW
#define CY_PSE_SDIO0_IRQ             CYBSP_WIFI_SDIO_IRQ
#define CY_PSE_SDIO0_CONFIG          CYBSP_WIFI_SDIO_config
#define CY_PSE_SDIO0_HAL_CONFIG      CYBSP_WIFI_SDIO_sdhc_hal_config
#elif defined(TARGET_APP_KIT_PSE84_EVAL_EPC2)
#define CY_PSE_SDIO0_HW              CYBSP_SDHC_0_HW
#define CY_PSE_SDIO0_IRQ             CYBSP_SDHC_0_IRQ
#define CY_PSE_SDIO0_CONFIG          CYBSP_SDHC_0_config
#define CY_PSE_SDIO0_HAL_CONFIG      CYBSP_SDHC_0_sdhc_hal_config
#else
#error "BSP_USING_SDIO0 requires an explicit board SDHC0 descriptor"
#endif
...
{
    .hw_base = CY_PSE_SDIO0_HW,
    .sdhc_obj = &sdhc0_obj,
    .pdl_config = &CY_PSE_SDIO0_CONFIG,
    .hal_config = &CY_PSE_SDIO0_HAL_CONFIG,
};
